...
.. _rst_dist_dunnett2_t: 

Distribution of Dunnett's `t`, two-sided
-------------------------------------------------------------------------------


.. py:class:: ctx.dist_dunnett2_t(rho, k, nu)
...
.. method:: dist_dunnett2_t.k_x(t, k = 0)
...
.. method:: dist_dunnett2_t.moments(k)
...
.. method:: dist_dunnett2_t.cumulants(k)
