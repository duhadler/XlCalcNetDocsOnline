...
.. py:class:: ctx.dist_wilks_cs(p, bi, ci)
...
.. method:: dist_wilks_cs.k_x(t, k = 0)
...
.. method:: dist_wilks_cs.moments(k)
...
.. method:: dist_wilks_cs.cumulants(k)
