...
.. method:: dist_logrv_beta_sum.pdf(x)
...
.. method:: dist_logrv_beta_sum.cdf(x)
...
.. method:: dist_logrv_beta_sum.sf(x)
...
.. method:: dist_logrv_beta_sum.qtf(q)
...
.. method:: dist_logrv_beta_sum.isf(q)
...
.. method:: dist_logrv_beta_sum.c_x(t)
...
.. method:: dist_logrv_beta_sum.m_x(t)
...
.. method:: dist_logrv_beta_sum.k_x(t, k = 0)
...
.. method:: dist_logrv_beta_sum.moments(k)
...
.. method:: dist_logrv_beta_sum.cumulants(k)
...
.. method:: ctx.beta_product_ecf(x, ai, bi, results='cdf')
...
.. method:: ctx.beta_product_ecf_inv(q, ai, bi, results='qtf')
