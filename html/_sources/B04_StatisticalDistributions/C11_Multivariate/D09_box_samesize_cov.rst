...
.. method:: dist_box_nsame_cov.pdf(x)
...
.. method:: dist_box_nsame_cov.cdf(x)
...
.. method:: dist_box_nsame_cov.sf(x)
...
.. method:: dist_box_nsame_cov.qtf(q)
...
.. method:: dist_box_nsame_cov.isf(q)
...
.. method:: dist_box_nsame_cov.c_x(t)
...
.. method:: dist_box_nsame_cov.m_x(t)
...
.. method:: dist_box_nsame_cov.k_x(t, k = 0)
...
.. method:: dist_box_nsame_cov.moments(k)
...
.. method:: dist_box_nsame_cov.cumulants(k)
...
.. method:: ctx.box_spa(x, p, n1, n2, results='c')
    ...
    Returns `K_X(s)`, the cumulant generating function, and its `j^{\text{th}}` derivatives, `K_X^{(j)}(s), j = 1 \ldots k`, of a random variable `X`, following a Box-Davis distribution:
...
.. method:: ctx.box_spa_inv(x, n, results='qtf')
