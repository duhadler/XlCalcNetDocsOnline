...
.. _rst_dist_mann_whitney_lehmann: 

Noncentral Mann-Whitney U distribution, Lehmann alternatives
-------------------------------------------------------------------------------


.. py:class:: ctx.dist_mann_whitney_u_lehmann(m, n)
...
.. method:: dist_mann_whitney_u_lehmann.pmf(x)
...
.. method:: dist_mann_whitney_u_lehmann.cdf(x)
...
.. method:: dist_mann_whitney_u_lehmann.sf(x)
...
.. method:: dist_mann_whitney_u_lehmann.qtf(q)
...
.. method:: dist_mann_whitney_u_lehmann.isf(q)
...
.. method:: dist_mann_whitney_u_normal.g_x(t)
...
.. method:: dist_mann_whitney_u_lehmann.c_x(t)
...
.. method:: dist_mann_whitney_u_lehmann.m_x(t)
...
.. method:: dist_mann_whitney_u_lehmann.k_x(t, k = 0)
...
.. method:: dist_mann_whitney_u_lehmann.moments(k)

    Returns the first `j` moments, `\mu_j, j = 1 \ldots k`, of a random variable `X`, 
    following a Mann-Whitney U distribution under Lehmann alternatives (Wikipedia). The moments are calculated from the cumulants.
...
.. method:: dist_mann_whitney_u_lehmann.cumulants(k)

    Returns the first `j` cumulants, `\kappa_j, j = 1 \ldots k`, of a random variable `X`, 
    following a Mann-Whitney U distribution under Lehmann alternatives. 
